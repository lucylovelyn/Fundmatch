...
export const FOUNDER_REGISTRY_ABI = [
  {
    ...
    inputs: [
      { name: "_arr",      type: "uint32" },
      { name: "_growth",   type: "uint32" },
      { name: "_runway",   type: "uint32" },
      { name: "_industry", type: "uint32" },
...
export const INVESTOR_REGISTRY_ABI = [
  {
    ...
    stateMutability: "nonpayable",
    inputs: [
      { name: "_minArr",         type: "uint32" },
      { name: "_minGrowth",      type: "uint32" },
      { name: "_minRunway",      type: "uint32" },
      { name: "_targetIndustry", type: "uint32" },
      { name: "_targetStage",    type: "uint32" },
    ],
    outputs: [],
  },
  {
